-- DUMPED ON 25/07/2021 at 23:00:44
...
INSERT INTO `band` VALUES (1,'Opeth','logo-opeth.jpg','Opeth est un groupe de death metal progressif suédois, originaire de Stockholm. Fondé en 1990, le style d\'Opeth, basé en grande partie sur la présence continue du chanteur et guitariste Mikael Åkerfeldt, est bien ancré dans la tradition heavy metal. Le groupe est également sous-classé dans le death metal et le rock progressif (ou une combinaison de ces genres) selon l\'album et parfois la chanson à laquelle le critique se réfère. D\'une part, Opeth emprunte aux styles les plus brutaux à travers des chants gutturaux et des séquences instrumentales très agressives tandis que de l\'autre, il se distingue par des séquences progressives mélodiques, très souvent douces et envoûtantes. Cette apparente dichotomie est présente dans tous les albums du groupe bien qu\'à des degrés différents, ce qui rend sa classification dans un style musical d\'autant plus complexe.','https://fr-fr.facebook.com/Opeth/','https://twitter.com/OfficialOpeth','https://www.instagram.com/officialopeth/','https://www.youtube.com/opeth','https://soundcloud.com/roadrunnerrecords/02-opeth-the-devils-orchard','https://bandcamp.com/tag/opeth','opeth@niwee.fr',473123456);
...
-- Dump completed on 2021-07-25 21:00:48
